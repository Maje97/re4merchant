    ...
    return(
        <main class="h-[70%]">
            <article class="flex flex-col">
                ...
                <button onClick={() => AddtoCart({ index })} class="self-center text-s box-border size-fit p-2 border-solid rounded-3xl border-2 border-stone-500 bg-stone-300">Add to cart</button>
            </article>
        </main>
    );
}